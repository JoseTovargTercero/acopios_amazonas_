        ...
        <div class="col-md-5">
            <div class="card shadow-lg border-0">
                <div class="card-body p-4 text-center">
                    <i class="mdi mdi-warehouse text-primary" style="font-size: 4rem;"></i>
                    <h3 class="mt-2 mb-4 fw-bold">Acceso Administrativo</h3>
                    <p class="text-muted">Por favor ingrese el código de autorización para ver todos los ingresos a almacén.</p>
    ...
    <div class="row mt-4">
        <div class="col-12">
            <div class="page-title-box d-flex justify-content-between align-items-center">
                <h4 class="page-title text-uppercase fw-bold m-0"><i class="mdi mdi-warehouse text-primary"></i> Administración General de Almacén</h4>
            ...
            <div id="dashboardContent" class="d-none">
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        <div class="card shadow-sm border-0 h-100">
                            <div class="card-header bg-white fw-bold"><i class="mdi mdi-chart-pie text-primary me-1"></i> Ingresos por Centro</div>
                            <div class="card-body">
                                <canvas id="chartCentro" height="220"></canvas>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="card shadow-sm border-0">
                <div class="card-body p-4">
                    <div id="loader" class="text-center py-5">
                        <div class="spinner-border text-primary" role="status"></div>
                        <p class="mt-2 text-muted">Cargando ingresos a almacén...</p>
                    </div>
                    <div id="noData" class="text-center py-5 d-none">
                        <i class="mdi mdi-inbox-outline text-muted" style="font-size: 4rem;"></i>
                        <h4 class="mt-2 text-muted">No hay ingresos registrados</h4>
                    </div>
                    ...
                    <div id="accordionAlmacen" class="accordion custom-accordion d-none"></div>
                </div>
            </div>
        </div>
    </div>
...
<script type="module" src="<?= BASE_URL ?>public/assets/js/modules/admin_almacen_view.js"></script>
